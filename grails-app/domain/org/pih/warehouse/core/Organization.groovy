...
class Organization extends Party {
    ...
    static constraints = {
        code(nullable: false, unique: true,
                minSize: Holders.getGrailsApplication().config.openboxes.identifier.organization.minSize,
                maxSize: Holders.getGrailsApplication().config.openboxes.identifier.organization.maxSize)
